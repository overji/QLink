...
private slots:
    ...
    void oneTwistCorrectTest();//一折线正确消除方块
    void oneTwistCorrectTest2();//一折线正确消除方块
    ...
    void twoTwistCorrectTest();//两折线正确消除方块
    void twoTwistCorrectTest2(); //两折线正确消除方块
    ...
    void removeSelectedTest(); //消除选中的方块

...
#ifdef QT_MOC_HAS_STRINGDATA
struct qt_meta_stringdata_CLASSLoadPageENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSLoadPageENDCLASS = QtMocHelpers::stringData(
    "LoadPage",
    "returnOriginPage",
    ""
);
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSLoadPageENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSLoadPageENDCLASS_t qt_meta_stringdata_CLASSLoadPageENDCLASS = {
    {
        QT_MOC_LITERAL(0, 8),  // "LoadPage"
        QT_MOC_LITERAL(9, 16),  // "returnOriginPage"
        QT_MOC_LITERAL(26, 0)   // ""
    },
    "LoadPage",
    "returnOriginPage",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSLoadPageENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject LoadPage::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_CLASSLoadPageENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSLoadPageENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSLoadPageENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<LoadPage, std::true_type>,
        // method 'returnOriginPage'
        QtPrivate::TypeAndForceComplete<void, std::false_type>
    >,
    nullptr
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<LoadPage *>(_o);
        (void)_t;
        switch (_id) {
        case 0: _t->returnOriginPage(); break;
        default: ;
        }
    }
    (void)_a;
...
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_CLASSLoadPageENDCLASS.stringdata0))
        return static_cast<void*>(this);
    return QWidget::qt_metacast(_clname);
}
